...
async function testStickyHeaderHiding() {
    ...
    (0, test_1.expect)(toggleButton).toBeTruthy();
    const buttonColor = await toggleButton?.evaluate(el => window.getComputedStyle(el).backgroundColor);
    console.log(`  Toggle button color: ${buttonColor}`);
    (0, test_1.expect)(buttonColor).toContain('46, 164, 79'); // Green color RGB values
...
//# sourceMappingURL=test-sticky-header-fix.js.map