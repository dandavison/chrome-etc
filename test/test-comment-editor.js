...
async function testDoubleClickOnCodeBlock(context) {
...
async function runTests() {
    ...
    console.log('📁 Extension path:', path_1.default.resolve(__dirname, '..', 'dist'));
...
//# sourceMappingURL=test-comment-editor.js.map