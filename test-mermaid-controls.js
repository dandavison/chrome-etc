...
async function testMermaidControls() {
    ...
    for (const [button, info] of Object.entries(panControlsHidden)) {
    ...
    for (const [button, info] of Object.entries(zoomControlsVisible)) {
    ...
    if (styleInjected.exists) {
        console.log(`  Content preview: ${styleInjected.content.substring(0, 100)}...`);
    }
    // Perform assertions
...
//# sourceMappingURL=test-mermaid-controls.js.map